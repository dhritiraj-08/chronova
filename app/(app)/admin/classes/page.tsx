...
import { Plus, Trash2, Users, DoorOpen, X, AlertTriangle } from "lucide-react";
...
export default function ClassesPage() {
  const { batches, classrooms, isLoading, loadError, loadAdminData, addBatch, removeBatch, addClassroom, removeClassroom } = useInstitutionStore();
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {batches.map((b) => (
              <div key={b.id} className="card card-hover" style={{ padding: "18px 20px", display: "flex", gap: "16px", alignItems: "center" }}>
                ...
                <button onClick={() => removeBatch(b.id)} style={{ background: "none", border: "none", cursor: "pointer", color: "var(--c-danger)", padding: "6px", borderRadius: "8px", flexShrink: 0 }}
